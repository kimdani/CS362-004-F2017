...
int* kingdomCards(int k1, int k2, int k3, int k4, int k5, int k6, int k7,
  ...
  int initializeGame(int numPlayers, int kingdomCards[10], int randomSeed,
    ...
    int salvagerFunc(struct gameState *state, int currentPlayer, int handPos, int choice1){
    //+1 buy
    state->numBuys++;
            ...
            //discard card BUG actually trashses card
            discardCard(handPos, currentPlayer, state, 0);
    ...
    int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
    {
      ...
      {
        case adventurer:
        return adventurerFunc(state, currentPlayer, drawntreasure, cardDrawn, *temphand, z);
        ...
        case steward:
        return stewardFunc(state, currentPlayer, drawntreasure, choice1, choice2, choice3);
        ...
        case salvager:
        //+1 buy
        return salvagerFunc(state, currentPlayer, handPos, choice1);
